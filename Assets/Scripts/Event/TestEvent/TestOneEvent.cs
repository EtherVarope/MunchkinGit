...
namespace Munchkin
{
    class TestOneEvent : Base_Event
    {
        ...
        //--------------------------------------------------------------------------
        public TestOneEvent(MomentType momenttype = MomentType.None, int eventID = 1000, FunctionObjectType functionobjecttype = FunctionObjectType.None)
        {
        ...
        public override void Execute()
        {
            //事件接口;
            //----------------------------------------------------------------
            Debug.Log("this is   TestOneEvent and  My father name is"+ _fatherCard.GetName());
            //----------------------------------------------------------------
