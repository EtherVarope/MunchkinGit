...
namespace Munchkin
{
    class TestTwoEvent: Base_Event
    {
        ...
        //--------------------------------------------------------------------------
        public TestTwoEvent(MomentType momenttype = MomentType.None, int eventID = 1001, FunctionObjectType functionobjecttype = FunctionObjectType.None)
        {
        ...
        public override void Execute()
        {
            //事件接口;
            //----------------------------------------------------------------
            Debug.Log("this is   TestTwoEvent and  My father name is" + _fatherCard.GetName());
            //----------------------------------------------------------------
